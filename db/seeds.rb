...
restaurant2 = Restaurant.create(name: "restaurant2name", location: "00001", if_delivery?: false, food_type: "Chinese")
restaurant3 = Restaurant.create(name: "restaurant3name", location: "00002", if_delivery?: true, food_type: "Italian")
restaurant4 = Restaurant.create(name: "restaurant4name", location: "00002", if_delivery?: false, food_type: "Seafood")
